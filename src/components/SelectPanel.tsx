...
export default function SelectPanel(props: {
    ...
    function setPicked(e: Picked) {
        ...
        const document2 = document as unknown as Document & {startViewTransition: (a: ()=>void)=>void}
    ...
    return (
        <div className="w-full flex flex-col gap-5">
            <div className="flex gap-16 justify-center relative">
                ...
                <div id="paper-img" onMouseDown={()=>setPicked("paper")} className="transition hover:scale-110 cursor-pointer size-[10rem] z-20 rounded-full border-b-[8px] border-blue-800">
                ...
                <div id="scissors-img" onMouseDown={()=>setPicked("scissors")} className="transition hover:scale-110 cursor-pointer size-[10rem] z-20 rounded-full border-b-[8px] border-yellow-800">
            ...
            <div className="w-full flex justify-center relative">
                <div id="rock-img" onMouseDown={()=>setPicked("rock")} className="transition hover:scale-110 cursor-pointer size-[10rem] z-20 rounded-full border-b-[8px] border-red-800">
